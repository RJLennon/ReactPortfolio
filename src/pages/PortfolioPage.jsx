...
export default function PortfolioPage() {
  return (
    <div>
      ...
      <div class="row">
        <Project imageURL="/src/assets/Brewery_Finder.png" projectName="Brewery Finder" projectURL="https://bsaglimb.github.io/BreweryFinder/" projectDescription="Find local breweries"/>
        <Project imageURL="/src/assets/Employee_Tracker.png" projectName="Employee Tracker" projectURL="https://github.com/RJLennon/Challenge12" projectDescription="Employee database management system"/>
